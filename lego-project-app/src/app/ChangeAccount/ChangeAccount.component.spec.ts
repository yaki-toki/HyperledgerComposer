...
describe('ChangeAccountComponent', () => {
  ...
  let mockChangeAccountService;
  let mockDataService

  beforeEach(async(() => {

    mockChangeAccountService = sinon.createStubInstance(ChangeAccountService);
    mockChangeAccountService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: ChangeAccountService, useValue: mockChangeAccountService },
